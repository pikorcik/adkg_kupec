...
\clearpage
\section{Závěr}
Kartografické hledisko
nebude dávat výsledky
slabiny algoritmu (povinné a lomové hrany)

V rámci úlohy \textit{Digitální model terénu a jeho analýzy} byla vytvořena aplikace, která ze vstupní množiny bodů vytvoří digitální model terénu. Implementace některých algoritmů byla náročná, avšak výsledek je obstojný. 
