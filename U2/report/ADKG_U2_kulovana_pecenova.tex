...
V algoritmu \textit{Sweep Line} bylo nutné ošetřit singularitu, která způsobovala generování nekonvexní obálky. Konkrétně bylo nutné odstranit duplicitní body.\\
...
\begin{figure}[h!]
	...
	\caption{Výstup při použití algoritmu \textit{QHull} nad množinou \textit{Raster} o 1000 bodech}
\end{figure}
~
...
%generacebodů přizpůsobena canvasu
%data vypisována do konzole
%pravidelný rastr -> zaokrouhlení nahoru
